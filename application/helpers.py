...
DATABASE_VMS = f"{curdir}{config['DATABASE_VMS']}"
DATABASE_USERS = f"{curdir}{config['DATABASE_USERS']}"
DATABASE_MONITORING = f"{curdir}{config['DATABASE_MONITORING']}"
MONITORING_PATH=f"{curdir}{config['MONITORING_PATH']}"
...
def read_json_file(path):
    ...
    try:
        ...
        logging.error("Error %s read_json_file %s", e, path)
